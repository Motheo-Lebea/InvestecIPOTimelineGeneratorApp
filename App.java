...
public class App extends JFrame {
    ...
    private void generateTimeline(ActionEvent e) {
        try {
            ...
            List<InvestecIPOTimelineGenerator.IPOPhase> timeline =
                    InvestecIPOTimelineGenerator.generateTimeline(ipoDate);

            Object[][] data = new Object[timeline.size()][3];
            for(int i = 0; i < timeline.size(); i++) {
                InvestecIPOTimelineGenerator.IPOPhase phase = timeline.get(i);
